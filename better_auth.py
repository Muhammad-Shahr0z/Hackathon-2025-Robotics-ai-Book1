...
import sys
import os
# Add the current directory to the path to allow imports from services and models
...
try:
    ...
    print(f"Import error in better_auth: {e}")
    # Define mock classes as fallback
    class AuthService:
        def __init__(self):
            pass
        ...
        async def create_user(self, first_name, last_name, email, password):
            return User(id="mock", first_name=first_name, last_name=last_name, email=email, password_hash="mock")
        async def create_session(self, user_id):
            return AuthSession(id="mock", user_id=user_id, session_token="mock", expires_at=None, created_at=None)
    ...
    class ValidationService:
        @staticmethod
        def validate_user_registration_data(first_name, last_name, email, password):
